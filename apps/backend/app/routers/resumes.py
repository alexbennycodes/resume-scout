...
async def improve_resume_preview_endpoint(
    ...
    """
    # Check usage limit for resume tailoring
...
async def improve_resume_confirm_endpoint(
    ...
    Requires authentication and logs usage for rate limiting.
    """
    # Check usage limit for resume tailoring
    allowed, message, _ = usage_tracker.check_limit(
        current_user.user_id,
...
async def download_resume_pdf(
    ...
    Requires authentication. PDF export is included in all plans.
    ...
    # Log PDF export usage
    usage_tracker.log_action(
        user_id=current_user.user_id,
        action_type=usage_tracker.ACTION_PDF_EXPORT,
    )
...
async def download_cover_letter_pdf(
    ...
    Requires authentication. Cover letters require Pro tier or higher.
